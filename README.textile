...
* There is a *config.rb* file where you are going to point to your music folder and where you want to save the xml file.
...
* Just run the *MusicLibrary.rb* (ruby MusicLibrary.rb)
* That's it!